...
from legacy_app.services.analysis_service import analyze_notes
from legacy_app.services.topic_service import generate_topics
...
async def run_agent_pipeline(request: AgentRunRequest) -> AgentRunResponse:
    ...
    1. request.items  鈥?injected directly (e.g. from test_crawl_result.json)
    2. data/raw/sample_notes.json  鈥?fallback sample data
    """
